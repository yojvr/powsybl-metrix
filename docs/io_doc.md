...
| NULLCOST | R | 1 | Bruit des coûts null = 0.5 |
| WRIPTDFS | B | 1 | Écriture des fichiers des matrices des PTDFs en N et par variante.<br>Valeur par défaut = false |
| LOSTCMAX | I | 1 | Nombre maximum de charges qui peuvent être perdues.<br>Valeur par défaut = 100U |
...
\text{<numéroVariante>} = 
\begin{cases}
    N\text{ pour la situation en N}\\
    var_i\text{ pour la situation suite à la variante }i
\end{cases}
$$
